...
class CampaignCheckpoint:
    ...
    def save(self) -> None:
        """Persist current state to disk (thread-safe, Windows-compatible)."""
        import time
        with self._lock:
            ...
            # os.replace can fail on Windows with WinError 5 if another thread
            # briefly holds the target file open.  Retry a few times before giving up.
